...
export default function EndMessage(){
  ...
  return(
    <Box sx={{position: "fixed", top: '50%', left: '50%', transform: 'translate(-50%, -50%)', width: '70vw', height: '70vh', backgroundColor: '#FFF'}} >
      ...
      {isHost
      ?<Button size='large' variant='contained' color="success" component={LinkRouter} to={`/questionnaire/questioner`} >回答する</Button>
      :<Button size='large' variant='contained' color="success" component={LinkRouter} to={`/questionnaire/respondent`} >回答する</Button>
      }
      </Stack>
